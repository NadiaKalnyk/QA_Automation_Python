...
def generate_password(length, use_digits=True, use_lowercase=True, use_uppercase=True, use_cyrillic=True):
    characters = ''
    if use_digits:
...
def main():
    ...
    password = generate_password(length, use_digits, use_lowercase, use_uppercase, use_cyrillic)
