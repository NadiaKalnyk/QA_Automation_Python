...
# За допомогою range отримуємо індекси елементів зі списка
# range_1 = range(2, 11, 2) # список від 2 до 11 з кроком 2
# print(range_1)
# print(list(range_1))
...
# пиши це
# За допомогою enumerate отримуємо індекси + значення елементів зі списка
# for i, j in enumerate(list_a): # i - індекс, j - значення
#     print(f"{i=}, {j=}")
#     print(j)
...
# DICT (записати) - це впорядкована колекція елементів, яка зберігає їх у вигляді пари “ключ-значення”.
# Ключ — це унікальний ідентифікатор, який пов'язаний із кожним значенням.
dict_1 = {}
dict_2 = dict()
dict_3 = {'city': "Odesa", 'village': "Myrne"}
