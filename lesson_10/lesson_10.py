...
from random import randint as rrandint # змінюємо назву методу з randint на rrandint
# rrandint

from random import *  # імпортує всі функції == так не робіть

# ВЗАЄМОДІЯ З ФАЙЛАМИ
# file = open("text.txt", "r")  # читання файла (перший варіант)
# for i in file:
#     print(i)
#     print("---")
# file.close()

# with open("text.txt", "r") as file:  # читання файла (кращий варіант, тому що контекстний менеджер сам закриває файл)
#     for i in file:
#         print(i)


# with open("text.txt", "w") as file:  # w - записувння файлів. write витирає весь вміст файлу і записує нові дані
#     file.write("Hello")


# with open("tex2t.txt", "a") as file:  # a - дозапис файлів. Поточні дані без змін + нові дані у файл
#     file.write("\n")
#     file.write("++-=-=-=-=-")
